...
public class DeciBaby {
	...
	public DeciBaby ( int saValeur){
		this.valeur = saValeur;
	}
	
	public String convDeciBaby(){
		int quotient=0, n=5; // initilisation de la puissance a 5	
		String attribut=""; // initialisation de la variable a retourner a une chaine vide
		int nombre = this.valeur; // On initialise une variable nombre qui prend la valeur du nombre  a convertir
		...
		nombre = nombre%(int)Math.pow(60, n);
		n--;
		}	
		return attribut;
	}
